...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    if($row3['consultation']==0 || $row3['law']==0 || $row3['court']==0|| $row3['typing']==0)
  ...
  <tbody>
    <tr>
      ...
      <th scope="row">'.$row3['court'].'</th>
            ...
            <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-info"><a  href="../sign-in/updatefees.php?id='.$id.'">Edit fees</a></button>
